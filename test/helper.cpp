...
TEST(helper, fftshift) {
  xt::xtensor<double, 1> odd = {3, 4, 0, 1, 2};
  xt::xtensor<double, 1> even = {3, 4, 5, 0, 1, 2};
  xt::xtensor<double, 1> odd_range = xt::arange<double>(5);
  xt::xtensor<double, 1> even_range = xt::arange<double>(6);
...
TEST(helper, fftfreq) {
  xt::xtensor<double, 1> reference9 = {0.,  1.,  2.,  3.,  4., -4., -3., -2., -1.};
  xt::xtensor<double, 1> reference10 = {0.  ,  0.04,  0.08,  0.12,  0.16, -0.2 , -0.16, -0.12, -0.08, -0.04};
...
TEST(helper, rfftfreq) {
  xt::xtensor<double, 1> reference9 = {0.,  1.,  2.,  3.,  4.};
  xt::xtensor<double, 1> reference10 = {0.  ,  0.04,  0.08,  0.12,  0.16, 0.2};
